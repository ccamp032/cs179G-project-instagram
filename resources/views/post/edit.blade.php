...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" action="{{ route('post.editPost') }}" autocomplete="off" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  <form runat="server">
                    <img style="display:block; margin:auto; text-align: center;" id="blah" src="{{ url($postInformation['img_url']) }}" alt="" />
                  </form>
                </div>
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('image') ? ' has-danger' : '' }}">
                      <input style="width:85%;" class="form-control{{ $errors->has('image') ? ' is-invalid' : '' }}" name="image" id="input-image" type="file" />
                      @if ($errors->has('image'))
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                      <input style="width:85%;" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" id="input-description" type="text" placeholder="{{ __('Description') }}" value="{{ $postInformation['description'] }}" required="true" aria-required="true"/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('misc_tags') ? ' has-danger' : '' }}">
                      <input style="width:85%" class="" name="misc_tags_name" id="misc_input-tags" type="text" placeholder="{{ __('Misc Tags') }}" value="{{ $postInformation['misc_tags'] }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('user_tags') ? ' has-danger' : '' }}">
                      <input style="width:85%;" class="" name="user_tags_name" id="user_input-tags" type="text" placeholder="{{ __('User Tags') }}" value="{{ $postInformation['user_tags'] }}" />
              ...
              <div class="card-footer ml-auto mr-auto">
                <input type="hidden" name="post_id" value="{{ $postInformation['id'] }}" />
                <button id="submit_post" type="submit" class="btn btn-primary">{{ __('Save') }}</button>
              </div>
            </div>
          </form>
        </div>
